...
public class Player implements AmericanTenPinScoringSystem {
     ...
     */
    private final Map<Integer, Play> playByFrame;
     ...
     * @param play
     */
    public void addPlay(Integer frameId, Play play) {
	...
	this.currentScore += calculatePlayPointsAndBonus(this.playByFrame.get(frameId - 1), play);
    }
    ...
    public Map<Integer, Play> getPlays() {
